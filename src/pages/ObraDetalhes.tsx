  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="space-y-4">
        ...
        <div className="w-full rounded-lg border border-border bg-muted/20 p-4 max-h-[600px] overflow-x-auto overflow-y-auto scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent">
